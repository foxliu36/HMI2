...
namespace HMI.Entity
{
    ...
    public partial class TB_EIP_ALBUM
    {
        public string ALBUM_GUID { get; set; }
        public string CLASS_GUID { get; set; }
        public string ALBUM_TOPIC { get; set; }
        public string ALBUM_DESC { get; set; }
        public string ALBUM_RM_ID { get; set; }
        public string FILE_GROUP_ID { get; set; }
        public Nullable<System.DateTime> PHOTO_LATEST_TIME { get; set; }
        public Nullable<int> PHOTO_COUNT { get; set; }
